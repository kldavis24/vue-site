    ...
    export default {
        ...
        methods: {
            swapText(event) {
                ...
                let text = document.getElementById(`${skill}-text`)

                if (text.classList.contains('add-blue')) {
                    text.classList.remove('add-blue')
                    text.classList.add('add-black')
                } else {
                    text.classList.remove('add-black')
                    text.classList.add('add-blue')
                }
            }
        }
    }
